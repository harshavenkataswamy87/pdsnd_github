...
"""CITY_DATA is a dictionary which contains the city name as 'key' and 'value' as the csv file
    which contains user information
   MONTH is a list of month names for which bikeshare data needs to be displayed
   DAY is a list of day names for which bikeshare data needs to be displayed"""
